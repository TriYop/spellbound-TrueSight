...
- detect EQ issues (per band level with psychoacoustic perception such as muddiness, crispiness, ...)
- detect spectrum fullness
- detect Energy level issues (energy range)
